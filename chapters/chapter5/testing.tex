...
The JUST Undergraduate Final Admission System needs to be tested well. This is an important part of making sure the system works correctly before we use it for the 2026 admission session. We want to make sure the JUST Undergraduate Final Admission System is reliable, secure and correct.
...
We used Vitest to test the Undergraduate Final Admission System because it is built on the Next.js framework. Vitest helps us test the parts of the JUST Undergraduate Final Admission System like the functions and components to make sure they work correctly.
...
We did tests to make sure the JUST Undergraduate Final Admission System works well from a users point of view. We tested the admission form to make sure it works correctly. We tried submitting the form without filling in all the required fields. We got an error message.
...
\begin{table}[h]
    ...
    \end{tabular}
    \caption{Summary of Testing Results for JUST-UFAS}
