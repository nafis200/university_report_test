...
\begin{itemize}[leftmargin=*, labelsep=0.3cm]
    ...
    Charged with the responsibility of evaluating the academic qualifications of students through verification of education certificates. The Dean’s office makes it possible to either approve or disapprove applications.
    \begin{itemize}
    ...
    Deals with all financial and residence related issues such as the clearance of payment of admission costs using bank slips.
    \begin{itemize}
    ...
    Enables the health evaluation process by capturing applicant’s medical details and carrying out physical examinations.
    \begin{itemize}
    ...
    The final authority in the approval of applications for admissions. The module collects, stores and manages the information of admitted students.
    \begin{itemize}
    ...
    The module helps the students register themselves, update their profile information, and apply for admissions by submitting the application form.
    \begin{itemize}
