...
\begin{itemize}
    ...
    \item {Cost Effectiveness:} The system will help reduce costs by minimizing the need, for labor and paper-based processes.

    \item {Objectivity:} The admission process will be fair and unbiased. The system will evaluate applicants based on objective criteria.
