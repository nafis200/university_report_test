...
This use case explains how users log into the \textit{JUST Undergraduate Final Admission System}. It ensures that only authorized users such as staff members and applicants can access the system and its features.
...
\begin{table}[htbp]
    ...
    \caption{Use Case Table: Login Process (UC-1.1)}
